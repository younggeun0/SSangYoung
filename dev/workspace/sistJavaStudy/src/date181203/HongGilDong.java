...
/**
 * 사람의 공통 특징을 부모(Person)로 부터 사용하고 자신만의 특징만 정의 홍길동 - 싸움 잘한다
 * 
 * @author owner
 */
public class HongGilDong extends Person {
	...
	/**
	 * 싸움하는 일 : 입력된 레벨보다 낮다면 패배, 입력된 레벨보다 높다면 승리, 입력된 레벨과 같다면 비김 반환 승리하면 레벨이 1증가,
	 * 패배하면 레벨 1감소, 비기면 레벨 변화없음 레벨은 최대 10, 최소 0을 가진다.
	 * 
	...
	public String eat(String menu, int price) {
		return super.getName() + "이(가) 주막에서 " + menu + "인 음식을 " + price + "냥 내고 사먹는다.";
	}
